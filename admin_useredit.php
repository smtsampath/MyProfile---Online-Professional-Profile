...
<?php
	  ...
	  if(isset($_POST['linfo_update'])){
		  ...
		  if($firstname == "" || $lastname == "" || $username == "" || $password == "" || $re_password == "" || $email == "" ) {
    ...
    <div id="container">
        ...
        <div class="mview" >
         <table width="585" border="0">
          <tr>
            <td width="385" align="right" valign="middle"><?php echo  $firstname . " " .  $lastname; ?></td>
            <td width="200" height="85" align="center" valign="middle" rowspan="3">
             <?php
          ...
          <tr>
            <td align="right" valign="middle"><?php echo  $pro_headline; ?></td>
          </tr>
          <tr>
            <td align="right" valign="middle"><?php echo  $country . " | " . $industry; ?></td>
          </tr>
          </table>
        </div>
        ...
        <form action="admin_useredit.php?id=<?php echo $user_id; ?>" method="post">
        ...
        <span style="color:#F00; font-size:10px;">*</span></div>
        <div class="style_form">
          <label for="username" class="mlabel">Change Username :</label>
          <input type="text" name="username" id="username" class="form_element"  value="<?php echo  mysql_prep($username); ?>" />
        <span style="color:#F00; font-size:10px;">*</span><span id="availability_status"></span> </div>
        <div class="style_form">
        ...
        <div class="style_form">
          <label for="email" class="mlabel">Change Email  :</label>
...
?>	  
       <div class="tform_head">+ Educational Profile</div>
        <div class="tform_body">
          <form action="admin_useredit.php?id=<?php echo $user_id; ?>" method="post" id="edu_profile">
          <div class="style_form" >
...
?>
              ...
              <td class="mdata_table_td"><a href="admin_user_eduedit.php?id=<?php echo $user_id; ?>&amp;rid=<?php echo $row[0]; ?>">Edit</a></td>
              <td class="mdata_table_td"><a href="admin_user_eduremove.php?id=<?php echo $user_id; ?>&amp;rid=<?php echo $row[0]; ?>" onClick="return remove_confirm();">Remove</a></td>
        	</tr>
 <?php } ?>    
           </table>
          </div> 
...
?> 
        ...
        <div class="tform_body">
        <form action="admin_useredit.php?id=<?php echo $user_id; ?>" method="post" id="pro_profile">
          <div class="style_form" >
...
?>
              ...
              <td class="mdata_table_td"><a href="admin_user_profedit.php?id=<?php echo $user_id; ?>&amp;rid=<?php echo $row[0]; ?>">Edit</a></td>
              <td class="mdata_table_td"><a href="admin_user_profremove.php?id=<?php echo $user_id; ?>&amp;rid=<?php echo $row[0]; ?>" onClick="return remove_confirm();">Remove</a></td>
        	</tr>
 <?php } ?> 
           </table>
        </div>
        ...
        <div class="tform_body">
          <div class="tupform_body"> 
            <form action="admin_useredit.php?id=<?php echo $user_id; ?>" method="post" id="image_upload" enctype="multipart/form-data">
            ...
            <span class="join_txt">or <a href="admin_user_imgremove.php?id=<?php echo $user_id; ?>" onClick="return remove_confirm();">Delete Photo</a></span>
          	</p>
           </div>
            </form>
          </div>  
...
?>
              ...
              <td class="mdata_table_td"><a href="admin_user_cvremove.php?id=<?php echo $user_id; ?>" onClick="return remove_confirm();">Remove</a></td>
        	</tr>
           </table>
        </div>
        </div>  
        ...
        <div class="tform_body">
            <form action="admin_useredit.php?id=<?php echo $user_id; ?>" method="post"  enctype="multipart/form-data">
            <div class="style_form">
...
?>
              ...
              <td class="mdata_table_td"><a href="admin_user_projectedit.php?id=<?php echo $user_id; ?>&amp;rid=<?php echo $row[0]; ?>">Edit</a></td>
              <td class="mdata_table_td"><a href="admin_user_projectremove.php?id=<?php echo $user_id; ?>&amp;rid=<?php echo $row[0]; ?>" onClick="return remove_confirm();">Remove</a></td>
        	</tr>
 <?php } ?> 
           </table>
        </div>
